 ...
 *
 *   ► GET /api/v1/transactions | ip: 10.244.0.1
 *   ... (service-layer step logs) ...
 *   ◄ 200 GET /api/v1/transactions | 18ms
 *
 * Order(2) — runs after CorrelationIdFilter (HIGHEST_PRECEDENCE).
 */
@Component
@Order(2)
@Slf4j
public class RequestLoggingFilter extends OncePerRequestFilter {
    ...
    private static final String[] SKIP_PATHS = {
            "/actuator", "/api/v1/transactions/health"
    };
